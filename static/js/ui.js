...
App.initEls = function() {
    ...
    App.els = {
        ...
        btnToggleDateFilter: $("btnToggleDateFilter"),
        registrosDateFilterContainer: $("registrosDateFilterContainer"),
        registrosDesde: $("registrosDesde"),
        registrosHasta: $("registrosHasta"),
        editarRegistroModal: $("editarRegistroModal"),
        editRegistroId: $("editRegistroId"),
        editRegistroRut: $("editRegistroRut"),
        editRegistroTrabajador: $("editRegistroTrabajador"),
        editRegistroArea: $("editRegistroArea"),
        editRegistroSubarea: $("editRegistroSubarea"),
